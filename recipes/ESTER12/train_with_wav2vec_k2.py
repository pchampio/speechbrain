...
def dataio_prepare(hparams):
    ...
    @sb.utils.data_pipeline.takes("file", "startTime", "endTime", "text")
    @sb.utils.data_pipeline.provides("sig")
    def audio_pipeline(wav, start, stop, text):
...
def arpa_to_fst(
    ...
    def _arpa_to_fst_single(arpa_path: Path, out_fst_path: Path, max_order: int):
        ...
        """
        if out_fst_path.exists() and os.path.getmtime(arpa_path) < os.path.getmtime(out_fst_path):
            return
